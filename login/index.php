...
//         exit();
//     } else {
//         $loginError = $loginResult; // Đặt thông báo lỗi
//     }
// }
session_start();
include ("../myclass/cls-admin.php");
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="post" id="form1" action="">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Nhập tên đăng nhập">
                        <input class="input100" type="text" name="txtuser" placeholder="Tên đăng nhập">
                    ...
                    <div class="container-login100-form-btn">
                        <button type="submit" name="dangnhap" class="login100-form-btn" value="Đăng Nhập">
                            Đăng Nhập
                        </button>
                    </div>
